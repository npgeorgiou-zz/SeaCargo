...
var dbUrl    = 'mongodb://' + config.db.user + ':' + config.db.password + '@ds063879.mongolab.com:63879/mongolabdb';
...
// Delete any data that might be in db
...
// Hacky but I can live with if for now: Sleep a bit to allow Mongo to delete all data, and then write
setTimeout(function() {
